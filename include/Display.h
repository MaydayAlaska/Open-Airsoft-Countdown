...
public:
	...
	void showDisarmPin(uint8_t enteredDigits, uint32_t remainingSeconds, uint8_t errorCount);
...
private:
	void drawHeader(uint32_t remainingSeconds, uint8_t errorCount, bool showTime);
